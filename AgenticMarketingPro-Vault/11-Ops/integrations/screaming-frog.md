---
type: integration
integration: screaming-frog
name: Screaming Frog CLI
purpose: Site crawler (annual license)
cost_tier: Paid (annual)
status: pending
last_health_check: DYNAMIC
tags: [integration, status/pending]
---

# Integration: Screaming Frog CLI

## Purpose
Site crawler (annual license)

## Status: PENDING
- **Cost tier:** Paid (annual)
...
- Reference name: `$SCREAMING-FROG_API_KEY`
