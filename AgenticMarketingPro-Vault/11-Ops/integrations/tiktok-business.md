---
type: integration
integration: tiktok-business
name: TikTok Business API
purpose: TikTok ads + organic
cost_tier: Free (ad spend separate)
status: pending
last_health_check: DYNAMIC
tags: [integration, status/pending]
---

# Integration: TikTok Business API

## Purpose
TikTok ads + organic

## Status: PENDING
- **Cost tier:** Free (ad spend separate)
...
- Reference name: `$TIKTOK-BUSINESS_API_KEY`
